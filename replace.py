...
def replace_in_file(file_path):
    ...
    try:
        ...
        old_text = '</head>'
        new_text = '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5152482106464455" crossorigin="anonymous"></script></head>'
